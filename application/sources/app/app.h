...
/*****************************************************************************/
/* define timer */
#define GAME_TIME_TICK_INTERVAL 		(100)
#define GAME_TIME_EXIT_INTERVAL			(3000)
/* define signal */
enum {
	GAME_INITIAL_SETUP = AK_USER_DEFINE_SIG,
	GAME_TIME_TICK = AR_GAME_DEFINE_SIG,
	GAME_RESET,
	GAME_EXIT_GAME,
};

/* define signal ARCHERY */
enum {
	GAME_ARCHERY_SETUP = AR_GAME_DEFINE_SIG,
	GAME_ARCHERY_UPDATE,
	GAME_ARCHERY_UP,
	GAME_ARCHERY_DOWN,
	GAME_ARCHERY_RESET,
...
/* define signal ARCHERY PERSON 2 */
enum {
	GAME_ARCHERY_2_SETUP = AR_GAME_DEFINE_SIG,
	GAME_ARCHERY_2_UPDATE,
	GAME_ARCHERY_2_UP,
	GAME_ARCHERY_2_DOWN,
...
/* define signal ARROW */
enum {
	GAME_ARROW_SETUP = AR_GAME_DEFINE_SIG,
	GAME_ARROW_RUN,
	GAME_ARROW_SHOOT,
...
/* define signal ARROW PERSON 2 */
enum {
	GAME_ARROW_2_SETUP = AR_GAME_DEFINE_SIG,
	GAME_ARROW_2_RUN,
	GAME_ARROW_2_SHOOT,
	GAME_ARROW_2_RESET,
};
...
/* define signal BORDER */
enum {
	GAME_BORDER_SETUP = AR_GAME_DEFINE_SIG,
	// GAME_LEVEL_UP,
	GAME_CHECK_GAME_OVER,
	GAME_BORDER_RESET,
};

/* define signal BORDER PERSON 2 */
enum {
	GAME_BORDER_2_SETUP = AR_GAME_DEFINE_SIG,
	// GAME_LEVEL_UP,
