...
game_meteoroid_t meteoroid[NUM_METEOROIDS];

#define GAME_METEOROID_SETUP() \
do { \
...
#define GAME_METEOROID_DETONATOR() \
do { \
...
void game_meteoroid_handle(ak_msg_t* msg) {
    switch (msg->sig)
    {
    case GAME_METEOROID_SETUP: {
        APP_DBG_SIG("GAME_METEOROID_SETUP\n");
        GAME_METEOROID_SETUP();
    }
        break;
    
    case GAME_METEOROID_RUN: {
        APP_DBG_SIG("GAME_METEOROID_RUN\n");
        GAME_METEOROID_RUN();
    }
        break;

    case GAME_METEOROID_DETONATOR: {
        APP_DBG_SIG("GAME_METEOROID_DETONATOR\n");
        GAME_METEOROID_DETONATOR();
    }
        break;

    case GAME_METEOROID_RESET: {
        APP_DBG_SIG("GAME_METEOROID_RUN\n");
